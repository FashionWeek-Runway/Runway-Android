...
class HomeInstaPagingSource(
    private val homeRepository: HomeRepository
) : PagingSource<Int, HomeInstaResponse>() {

    override fun getRefreshKey(state: PagingState<Int, HomeInstaResponse>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, HomeInstaResponse> {
        val position = params.key ?: Constants.INIT_PAGE_INDEX
        val loadData =
            homeRepository.getHomeInsta(
                page = position,
