object Dependencies {
    const val GOOGLE_SERVICE = "com.google.gms:google-services:${Versions.GOOGLE_SERVICES}"
    ...
    const val NAVIGATION_RUNTIME_KTX =
        "androidx.navigation:navigation-runtime-ktx:${Versions.NAVIGATION_COMPOSE}"
    const val NAVER_MAP_COMPOSE =
        "io.github.fornewid:naver-map-compose:${Versions.NAVER_MAP_COMPOSE}"
    const val NAVER_SDK = "com.naver.maps:map-sdk:${Versions.NAVER_SDK}"
    const val ANDROID_SUPPORT = "com.android.support"
    ...
    const val TOOLBAR_COMPOSE = "me.onebone:toolbar-compose:2.3.5"

    const val FIREBASE_CRASHLYTICS =
        "com.google.firebase:firebase-crashlytics-ktx:${Versions.FIREBASE_CRASHLYTICS_KTX}"
    const val FIREBASE_ANALYTICS =
        "com.google.firebase:firebase-analytics-ktx:${Versions.FIREBASE_ANALYTICS_KTX}"
